<!-- edit_talent.vue -->
<template>
    <form class="subcomponent" @submit.prevent="editRace()" id="form" v-if="race.id">

        <!-- Name & Cost -->
        <div class="background-tertiary title-card title">
            <div v-if="race.name" style="padding-left: 5px;">
                <input type="text" placeholder="Name" class="background-tertiary title-input text-dark" v-model="name" required/>
            </div>

            <div v-if="race.experience_cost" style="margin-left:auto; margin-right:0; padding-right: 5px;">
        ...
        <!-- Types & Book -->
        <div v-if="race" class="categories sub-title">
            <!-- Categories -->
            <p v-if="race.types" class="background-tertiary  category-card clickable"
        ...
        <!-- Talents -->
        <div v-if="race.traits" style="padding-top: 6px">
